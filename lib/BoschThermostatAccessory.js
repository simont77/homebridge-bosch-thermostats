...
class BoschThermostatAccessory {
    constructor(platform, accessory, log, thermostat) {
        ...
        this.state = platform.Characteristic.TargetHeatingCoolingState.HEAT;
    ...
    handleCurrentHeatingCoolingStateGet(callback) {
        ...
        if (this.thermostat.currentTemperature >= this.thermostat.targetTemperature || this.state==this.platform.Characteristic.TargetHeatingCoolingState.OFF) {
    ...
    handleTargetHeatingCoolingStateGet(callback) {
        ...
        callback(null, this.state); //platform.Characteristic.TargetHeatingCoolingState.AUTO);
    }
    /**
    ...
    handleCurrentHeatingCoolingStateSet(value, callback) {
        debug('Triggered SET CurrentHeatingCoolingState:', value);
        callback(null);
    }
    /**
